...
namespace bookApi.infrastructure.Data
{
    public class DataSeeder
    {
        ...
        public DataSeeder(ApplicationDbContext context, IPasswordEncryptionService passwordEncryptionService)
        {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                _context.Users.AddRange(
                    new User
                    {
                        ...
                        Password = _passwordEncryptionService.HashPassword("123456$Admin"),
                    ...
                    new User
                    {
                        ...
                        Username = "user",
                        Email = "user@user.com",
                        Password = _passwordEncryptionService.HashPassword("123456$User"),
            ...
            // 4) ReadingStatuses
            if (!await _context.ReadingStatuses.AnyAsync())
            {
                _context.ReadingStatuses.AddRange(
            ...
            if (!await _context.Books.AnyAsync())
            {
                _context.Books.AddRange(
                  new Book { Id = 1, Title = "The Hobbit", Author = "J.R.R. Tolkien", PublishYear = 1937, Description = "A fantasy novel…", CoverUrl = "https://…", PageCount = 310 },
                  new Book { Id = 2, Title = "Dune", Author = "Frank Herbert", PublishYear = 1965, Description = "A sci-fi novel…", CoverUrl = "https://…", PageCount = 412 },
